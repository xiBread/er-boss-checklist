...
<div class="absolute flex gap-2 top-4 right-4">
	<button
		class="flex items-center justify-center size-10 rounded-md border border-border hover:bg-accent hover:cursor-pointer"
		type="button"
		onclick={() => checked.clear()}
		aria-label="Reset list"
	>
		<svg class="fill-foreground size-5" width="32" height="32" viewBox="0 0 256 256">
			<path

...
<div class="absolute top-4 right-4">
	<button
		class="flex items-center justify-center size-10 rounded-md *:size-5 border border-border hover:bg-accent hover:cursor-pointer"
		onclick={toggleMode}
	>
		{#if mode.current === "light"}
			<svg class="fill-foreground" width="32" height="32" viewBox="0 0 256 256">
				<path
